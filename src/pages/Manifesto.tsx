...
自证能力：✅ 可自证`,
  ...
  sec5Title: '五、生态：8 大产品矩阵',
  sec5Lead:
    'MetaGO 不是一个安装包，而是一个产品矩阵——从单一 Kit 进化为 8 大产品，覆盖规则注入、协议集成、开发工具与生态基础设施。',
  ...
  closing: {
    ...
    body4: '8 条公理。7 条属性。6 项协议。37 个技能。7 大平台。8 大产品。',
    body5: '这不是终点，是进化的起点。',
...
Self-proof capability: ✅ Available`,
  ...
  sec5Title: 'V. Ecosystem: 8-Product Matrix',
  sec5Lead:
  ...
  closing: {
    ...
    body4: '8 axioms. 7 attributes. 6 protocols. 37 skills. 7 platforms. 8 products.',
