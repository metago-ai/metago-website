...
const stats: Stat[] = [
  ...
  { end: 39, labelKey: 'about.statsSkills', hue: 'evo', icon: Cpu },
  { end: 37, labelKey: 'about.statsMcpTools', hue: 'life', icon: Plug },
...
const productCards: ProductCard[] = [
  ...
  {
    icon: ShieldCheck,
    titleKey: 'about.verifyKit.title',
    tagKey: 'about.verifyKit.tag',
    descKey: 'about.verifyKit.desc',
    hue: 'evo',
    code: 'npm install -D @metago-ai/verify-kit',
  },
];
